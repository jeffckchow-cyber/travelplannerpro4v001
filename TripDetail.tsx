...
import { ActivityType, Attachment, Activity, Stay, TransportDetail } from './types';
...
export const TripDetail: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#1C1C1E] text-white overflow-hidden">
      {/* BANNER SECTION - EXTENDED VERTICALLY */}
          ...
          <div className="flex justify-between items-center pointer-events-auto">
            ...
            <div className="flex gap-1.5">
                ...
                <button 
                  ...
                  className="p-2 bg-black/40 backdrop-blur-md rounded-full text-white hover:bg-[#D4AF37] hover:text-black transition-all pointer-events-auto"
                  title="Banner Settings & Crop"
                >
                    <Maximize2 size={18} />
                </button>
                <button 
          ...
          {activeSubTab === 'itinerary' && (
            <div className="space-y-4">
              ...
              <div className="relative pl-6 space-y-4">
                ...
                {/* STAY LIST */}
                {/* Fixed Error: Use 'trip.stays' instead of undefined 'stay.stays' */}
